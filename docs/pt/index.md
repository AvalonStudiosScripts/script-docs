...
| [avalon_mounts](scripts/mounts.md) | Criaturas montáveis (dragões, grifos, pégasos...) | ✅ |
| [avalon_party](scripts/party.md) | Sistema de party MMORPG com HUD, barras vitais, masmorras | ✅ |
